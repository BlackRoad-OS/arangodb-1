...
auto SingleRemoteModificationExecutor<
  ...
  if (_info._outputRegisterId.isValid()) {
    AqlValue value(outDocument, 0, &_info.query().resourceMonitor());
  ...
  if (_info._outputOldRegisterId.isValid()) {
    ...
    AqlValue value(oldDocument, 0, &_info.query().resourceMonitor());
    AqlValueGuard guard(value, true);
  ...
  if (_info._outputNewRegisterId.isValid()) {
    ...
    AqlValue value(newDocument, 0, &_info.query().resourceMonitor());
    AqlValueGuard guard(value, true);
