...
class NewBatchedLifoQueue {
 public:
  ...
  explicit NewBatchedLifoQueue(arangodb::ResourceMonitor& resourceMonitor)
      : _resourceMonitor{resourceMonitor} {}
  ~NewBatchedLifoQueue() { this->clear(); }
  ...
  friend auto inspect(Inspector& f, NewBatchedLifoQueue<S, C>& x);

 private:
  using Entry = NewQueueEntry<Step, std::reference_wrapper<Cursor>>;
...
auto inspect(Inspector& f, NewBatchedLifoQueue<StepType, C>& x) {
