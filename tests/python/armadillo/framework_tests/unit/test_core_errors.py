...
class TestProcessErrors:
    ...
    def test_process_crash_error(self):
    ...
    def test_process_crash_error_without_signal(self):
...
class TestServerErrors:
    ...
    def test_health_check_error_minimal(self):
...
class TestTimeoutErrors:
    ...
    def test_watchdog_timeout_error(self):
...
class TestCheckerErrors:
    ...
    def test_invariant_violation_error_without_violations(self):
...
class TestErrorHierarchy:
    ...
    def test_codec_error_hierarchy(self):
    ...
    def test_cluster_error_hierarchy(self):
    ...
    def test_result_error_hierarchy(self):
    ...
    def test_checker_error_hierarchy(self):
