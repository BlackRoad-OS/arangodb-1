...
class FilesystemService:
    ...
    def atomic_write(self, path: Path, data: Union[str, bytes], mode: str='w') -> None:
        ...
        try:
            with tempfile.NamedTemporaryFile(mode=write_mode, dir=path.parent, delete=False, prefix=f'.{path.name}.tmp') as tmp_file:
