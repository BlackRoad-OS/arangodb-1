...
class JsonCodec(DataCodec):
    ...
    def _json_serializer(self, obj: Any) -> Any:
        ...
        if isinstance(obj, datetime):
            ...
            # Serialize dataclass/object with __dict__
            return obj.__dict__
    ...
    def _json_deserializer(self, dct: dict) -> dict:
        ...
        # This is a basic implementation - can be extended for specific object reconstruction
        return dct
...
class CodecManager:
    ...
    def __init__(self) -> None:
        self._codecs = {
            'json': JsonCodec(),
            'json_compact': CompactJsonCodec(),
            'vpack': VPackCodec(),  # Placeholder
        }
